...
from backend.views import UserRegisterView, Login, ContactView, SupplierUpdate, OrderCreationView, BasketView, \
    OrderConfirmationView, ShopView, CategoryView, ProductView, OrderView
